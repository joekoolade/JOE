...
//                Assert._assert(this.entsize == RelocEntry.getEntrySize());
            ...
            default:
                // unsupported.
                throw new IOException("bad section type: "+ Integer.toHexString(type));
            }
        }
    ...
    public abstract static class FakeSection extends Section {
        ...
        public int getEntSize() { throw new Error(); }
        public int getInfo() { throw new Error(); }
        public int getAddrAlign() { throw new Error(); }
        public int getLink() { throw new Error(); }
        public int getSize() { throw new Error(); }
        public int getType() { throw new Error(); }
        public int getFlags() { throw new Error(); }
        public int getAddr() { throw new Error(); }
        public int getIndex() { return index; }
        public void setName(String name) { throw new Error(); }
        public void setAddr(int addr) { throw new Error(); }
        public void setWrite() { throw new Error(); }
        public void clearWrite() { throw new Error(); }
        public void setAlloc() { throw new Error(); }
        public void clearAlloc() { throw new Error(); }
        public void setExecInstr() { throw new Error(); }
        public void clearExecInstr() { throw new Error(); }
...
//                    Assert._assert(s1.length() == in);
            ...
            while (i.hasNext()) {
                ...
                if (false) {
                    ...
                    } catch (UnsupportedEncodingException x) { throw new Error(); }
                }
            }
        }
