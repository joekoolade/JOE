...
public static final String[] string = {
	...
	"stm: IR_PROLOGUE",  	// 218
	"r: LONG_MUL(r,INT_CONSTANT)",  	// 219
	"r: LONG_MUL(r,r)",  	// 220
	"r: LONG_DIV(r,r)",  	// 221
	"r: LONG_DIV(r,REF_MOVE(INT_CONSTANT))",  	// 222
	"r: LONG_REM(r,r)",  	// 223
	"r: LONG_REM(r,REF_MOVE(INT_CONSTANT))",  	// 224
	"r: LONG_SHL(r,INT_CONSTANT)",  	// 225
	"r: LONG_SHL(r,r)",  	// 226
	"r: LONG_SHL(LONG_USHR(r,INT_CONSTANT),INT_CONSTANT)",  	// 227
	"r: LONG_USHR(LONG_SHL(r,INT_CONSTANT),INT_CONSTANT)",  	// 228
	"r: LONG_SHR(r,INT_CONSTANT)",  	// 229
	"r: LONG_SHR(r,r)",  	// 230
	"r: LONG_USHR(r,INT_CONSTANT)",  	// 231
	"r: LONG_USHR(r,r)",  	// 232
	"rs: INT_2LONG(r)",  	// 233
	"rs: INT_2LONG(rs)",  	// 234
	"r: LONG_2INT(r)",  	// 235
	"r: FLOAT_2LONG(r)",  	// 236
	"r: DOUBLE_2LONG(r)",  	// 237
	"r: DOUBLE_AS_LONG_BITS(r)",  	// 238
	"r: LONG_BITS_AS_DOUBLE(r)",  	// 239
	"r: REF_MOVE(ADDRESS_CONSTANT)",  	// 240
	"r: REF_MOVE(LONG_CONSTANT)",  	// 241
	"r: LONG_CMP(r,r)",  	// 242
	"stm: LONG_IFCMP(r,r)",  	// 243
	"stm: LONG_IFCMP(r,INT_CONSTANT)",  	// 244
	"stm: LONG_IFCMP(r,LONG_CONSTANT)",  	// 245
	"stm: INT_IFCMP(ATTEMPT_INT(r,r),INT_CONSTANT)",  	// 246
	"stm: INT_IFCMP(ATTEMPT_ADDR(r,r),INT_CONSTANT)",  	// 247
	"rz: INT_2ADDRZerExt(rz)",  	// 248
	"rz: INT_2ADDRZerExt(r)",  	// 249
	"rz: INT_2ADDRZerExt(INT_LOAD(r,INT_CONSTANT))",  	// 250
	"rz: INT_2ADDRZerExt(INT_LOAD(r,r))",  	// 251
	"rz: INT_2ADDRZerExt(INT_LOAD(REF_ADD(r,INT_CONSTANT),INT_CONSTANT))",  	// 252
	"r: LONG_LOAD(r,INT_CONSTANT)",  	// 253
	"r: LONG_LOAD(r,REF_MOVE(ADDRESS_CONSTANT))",  	// 254
	"r: LONG_LOAD(r,r)",  	// 255
	"r: LONG_LOAD(REF_ADD(r,r),INT_CONSTANT)",  	// 256
	"r: LONG_LOAD(REF_ADD(r,INT_CONSTANT),INT_CONSTANT)",  	// 257
	"stm: LONG_STORE(r,OTHER_OPERAND(r,INT_CONSTANT))",  	// 258
	"stm: LONG_STORE(r,OTHER_OPERAND(r,REF_MOVE(ADDRESS_CONSTANT)))",  	// 259
	"stm: LONG_STORE(r,OTHER_OPERAND(r,r))",  	// 260
	"stm: LONG_STORE(r,OTHER_OPERAND(REF_ADD(r,INT_CONSTANT),INT_CONSTANT))",  	// 261
	"r: PREPARE_ADDR(r,r)",  	// 262
	"r: ATTEMPT_ADDR(r,r)",  	// 263
};
