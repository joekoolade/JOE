...
public interface HeapLayoutConstants {
  ...
  Address BOOT_IMAGE_CODE_START =
    Address.fromIntZeroExtend( 0x03000000 );
  ...
  Address MAXIMUM_MAPPABLE =
    Address.fromIntZeroExtend( 0xF0000000 );
...
//  int BOOT_IMAGE_DATA_SIZE = 56<<20;
  ...
  int BAD_MAP_COMPRESSION = 20;  // conservative heuristic
  ...
  Address BOOT_IMAGE_DATA_END = BOOT_IMAGE_CODE_START; //BOOT_IMAGE_DATA_START.plus(BOOT_IMAGE_DATA_SIZE);
  /** The address of the end of the code section of the boot image. */
  Address BOOT_IMAGE_CODE_END = BOOT_IMAGE_RMAP_START; // BOOT_IMAGE_CODE_START.plus(0x800000);
