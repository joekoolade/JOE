...
public abstract class PrimitiveSubtypeHelper {
    protected PrimitivePA pa;
    ...
    public PrimitiveSubtypeHelper(PrimitivePA pa){
        this.pa = pa;
    }   
    ...
    public static class KnownClassesSubtypeHelper extends PrimitiveSubtypeHelper {
        static final String kind = KNOWN;
        public KnownClassesSubtypeHelper(PrimitivePA pa) {
            super(pa);
    ...
    public static class OnlineSubtypeHelper extends PrimitiveSubtypeHelper {    
        private Map/*<jq_Class, Collection<jq_Class>>*/ type2subtypeCache = new HashMap();
        static final String kind = ONLINE;

        public OnlineSubtypeHelper(PrimitivePA pa) {
            super(pa);
    ...
    public static class OfflineSubtypeHelper extends PrimitiveSubtypeHelper {
        ...
        public OfflineSubtypeHelper(PrimitivePA pa) {
            super(pa);
    ...
    public static PrimitiveSubtypeHelper newSubtypeHelper(PrimitivePA pa, String kind) {
