...
public class JavaFileSystem extends FileSystem
{
  ...
  private final String javaHome = "/home/java";
  ...
  /*
   * A normal Unix pathname contains no duplicate slashes and does not end with a
   * slash. It may be the empty string.
   */
  ...
  /*
   * Check that the given pathname is normal. If not, invoke the real normalizer
   * on the part of the pathname that requires normalization. This way we iterate
   * through the whole pathname string only once.
   */
  ...
  private static int PATH_MAX = 4096;
  ...
  {
    int rv = JavaFsDev.getBooleanAttributes(f);
  ...
  {
    return JavaFsDev.checkAccess(f, access);
  }

  public long getLastModifiedTime(File f)
  {
    return JavaFsDev.getLastModifiedTime(f);
  }

  public long getLength(File f)
  {
    return JavaFsDev.getLength(f);
  }

  public boolean setPermission(File f, int access, boolean enable, boolean owneronly)
  {
    return JavaFsDev.setPermission(f, access, enable, owneronly);
  }
  ...
  public boolean delete(File f)
  {
    ...
    return JavaFsDev.delete(f);
  }

  public String[] list(File f)
  {
    return JavaFsDev.list(f);
  }

  public boolean createDirectory(File f)
  {
    return JavaFsDev.createDirectory(f);
  }
  ...
  public boolean rename(File f1, File f2)
  {
    ...
    cache.clear();
    javaHomePrefixCache.clear();
    return JavaFsDev.rename(f1, f2);
  }

  public boolean setLastModifiedTime(File f, long time)
  {
    return JavaFsDev.setLastModifiedTime(f, time);
  }

  public boolean setReadOnly(File f)
  {
    return JavaFsDev.setReadOnly(f);
  }
