...
{
  /**
   * The system dependent file descriptor. The value is 1 more than actual file
   * descriptor. This means that the default value 0 indicates that the file is
   * not open.
   */
  ...
  public void close() throws IOException
  {
    ...
    {
      /*
       * Decrement FD use count associated with the channel The use count is
   ...
   * bytes written to the file so far unless this stream is in append mode, in
   * which case it will be equal to the size of the file. Writing bytes to this
   * stream will increment the channel's position accordingly. Changing the
   * channel's position, either explicitly or by writing, will change this
