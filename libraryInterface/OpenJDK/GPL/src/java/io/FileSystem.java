...
abstract class FileSystem
{
   ...
   * may be accessed by this process. The second argument specifies which access,
   * ACCESS_READ, ACCESS_WRITE or ACCESS_EXECUTE, to check. Return false if access
   * is denied or an I/O error occurs
   */
  public abstract boolean checkAccess(File f, int access);

  /**
   * Set on or off the access permission (to owner only or to all) to the file or
   * directory denoted by the given abstract pathname, based on the parameters
   * enable, access and oweronly.
   */
  public abstract boolean setPermission(File f, int access, boolean enable, boolean owneronly);

  /**
   * Return the time at which the file or directory denoted by the given abstract
   * pathname was last modified, or zero if it does not exist or some other I/O
   * error occurs.
   */
  ...
  /**
   * Create a new empty file with the given pathname. Return <code>true</code> if
   * the file was created and <code>false</code> if a file or directory with the
   * given pathname already exists. Throw an IOException if an I/O error occurs.
   *
   * <p>
  ...
  /**
   * Rename the file or directory denoted by the first abstract pathname to the
   * second abstract pathname, returning <code>true</code> if and only if the
   * operation succeeds.
   */
   ...
   * abstract pathname, returning <code>true</code> if and only if the operation
   * succeeds.
   */
   ...
   * read-only, returning <code>true</code> if and only if the operation succeeds.
   */
