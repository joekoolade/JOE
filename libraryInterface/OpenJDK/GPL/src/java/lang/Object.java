 ...
 * <p>
 * Adjusted for Jikes RVM. The adjustments were not done using the replacement
 * class mechanism because that would have led to bootstrap problems with the
 * current implementation, e.g. when reading the annotations from the replacement
 * class.
 *
 * @author  unascribed
 * @see     java.lang.Class
