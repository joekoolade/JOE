...
class Thread implements Runnable {
   ...
   /**
    ...
    public final void start0() {
        ...
        RVMThread myThread = new RVMThread(this, stacksize, name, daemon, priority);
        JikesRVMSupport.setThread(myThread, this);
        myThread.start();
...
//        }
    ...
    private boolean isInterrupted(boolean ClearInterrupted) {
        RVMThread rvmThread = JikesRVMSupport.getThread(this);
...
//        }
    ...
    public State getState() {
        ...
        return State.RUNNABLE; // sun.misc.VM.toThreadState(threadStatus);
    }
