 ...
 * Representations</a> in the <code>Character</code> class for more
...
public final class String implements java.io.Serializable, Comparable<String>, CharSequence
{
   ...
   *           If the {@code offset} and {@code count} arguments index characters
   *           outside the bounds of the {@code value} array
   */
   ...
   * @throws IndexOutOfBoundsException
   *           If the {@code offset} and {@code count} arguments index characters
   *           outside the bounds of the {@code codePoints} array
   *
   * @since 1.5
   */
   ...
   *
   * @throws IndexOutOfBoundsException
   *           If the {@code offset} and {@code length} arguments index characters
   *           outside the bounds of the {@code bytes} array
   *
   * @since JDK1.1
   */
  ...
  */
   ...
   * from <code>0</code> to <code>length() - 1</code>. The first <code>char</code>
   * value of the sequence is at index <code>0</code>, the next at index
   ...
   * refers to <code>char</code> values (Unicode code units) and ranges from
   * <code>0</code> to {@link #length()}<code> - 1</code>.
   *
   * <p>
   ...
   * <code>String</code>, and the <code>char</code> value at the following index
   ...
   * index refers to <code>char</code> values (Unicode code units) and ranges from
   * <code>1</code> to {@link CharSequence#length() length}.
   *
   * <p>
   ...
   * 2)</code> is in the high-surrogate range, then the supplementary code point
   * value of the surrogate pair is returned. If the <code>char</code> value at
   * <code>index -
   ...
   * @exception IndexOutOfBoundsException
   *              if the <code>index</code> argument is less than 1 or greater
   ...
   * <code>String</code>. The text range begins at the specified
   ...
   * text range is <code>endIndex-beginIndex</code>. Unpaired surrogates within
   ...
   *              <code>String</code>, or <code>beginIndex</code> is larger than
   *              <code>endIndex</code>.
   * @since 1.5
   */
   ...
   * @exception IndexOutOfBoundsException
   *              if <code>index</code> is negative or larger then the length of
   *              this <code>String</code>, or if <code>codePointOffset</code> is
   *              positive and the substring starting with <code>index</code> has
   *              fewer than <code>codePointOffset</code> code points, or if
   ...
   * <p>
   * The first character to be copied is at index <code>srcBegin</code>; the last
   * character to be copied is at index <code>srcEnd-1</code> (thus the total
  ...
  public boolean equalsIgnoreCase(String anotherString)
  {
    ...
    : (anotherString != null) && (anotherString.count == count) && regionMatches(true, 0, anotherString, 0, count);
  }

  /**
   * Compares two strings lexicographically. The comparison is based on the
   * Unicode value of each character in the strings. The character sequence
   * represented by this <code>String</code> object is compared lexicographically
   * to the character sequence represented by the argument string. The result is a
   * negative integer if this <code>String</code> object lexicographically
   * precedes the argument string. The result is a positive integer if this
   * <code>String</code> object lexicographically follows the argument string. The
   * result is zero if the strings are equal; <code>compareTo</code> returns
   * <code>0</code> exactly when the {@link #equals(Object)} method would return
   * <code>true</code>.
   * <p>
   ...
   * <code>compareTo</code> returns the difference of the two character values at
   * position <code>k</code> in the two string -- that is, the value: <blockquote>
   * 
   * <pre>
   ...
   * <code>compareTo</code> returns the difference of the lengths of the strings
   ...
   * <code>Character.toLowerCase(Character.toUpperCase(character))</code> on each
   * character.
   * <p>
   ...
   * <p>
   * A substring of this <tt>String</tt> object is compared to a substring of the
   * argument other. The result is true if these substrings represent identical
   * character sequences. The substring of this <tt>String</tt> object to be
   * compared begins at index <tt>toffset</tt> and has length <tt>len</tt>. The
   * substring of other to be compared begins at index <tt>ooffset</tt> and has
   * length <tt>len</tt>. The result is <tt>false</tt> if and only if at least one
   * of the following is true:
   * <ul>
   * <li><tt>toffset</tt> is negative.
   * <li><tt>ooffset</tt> is negative.
   * <li><tt>toffset+len</tt> is greater than the length of this <tt>String</tt>
   * object.
   * <li><tt>ooffset+len</tt> is greater than the length of the other argument.
   * <li>There is some nonnegative integer <i>k</i> less than <tt>len</tt> such
   * that:
   ...
   * @return <code>true</code> if the specified subregion of this string exactly
   ...
   * <p>
   * A substring of this <tt>String</tt> object is compared to a substring of the
   * argument <tt>other</tt>. The result is <tt>true</tt> if these substrings
   * represent character sequences that are the same, ignoring case if and only if
   * <tt>ignoreCase</tt> is true. The substring of this <tt>String</tt> object to
   * be compared begins at index <tt>toffset</tt> and has length <tt>len</tt>. The
   * substring of <tt>other</tt> to be compared begins at index <tt>ooffset</tt>
   * and has length <tt>len</tt>. The result is <tt>false</tt> if and only if at
   ...
   * @param len
   *          the number of characters to compare.
   * @return <code>true</code> if the specified subregion of this string matches
   *         the specified subregion of the string argument; <code>false</code>
   *         otherwise. Whether the matching is exact or case insensitive depends
   *         on the <code>ignoreCase</code> argument.
   */
   ...
   *         index <code>toffset</code>; <code>false</code> otherwise. The result
   *         is <code>false</code> if <code>toffset</code> is negative or greater
   *         than the length of this <code>String</code> object; otherwise the
   ...
   *         <code>true</code> will be returned if the argument is an empty string
   ...
   *         <code>true</code> if the argument is the empty string or is equal to
   *         this <code>String</code> object as determined by the
   *         {@link #equals(Object)} method.
   */
   ...
   * character. If a character with value <code>ch</code> occurs in the character
   * sequence represented by this <code>String</code> object, then the index (in
   * Unicode code units) of the first such occurrence is returned. For values of
   * <code>ch</code> in the range from 0 to 0xFFFF (inclusive), this is the
   ...
   * 
   * </blockquote> is true. In either case, if no such character occurs in this
   * string at or after position <code>fromIndex</code>, then <code>-1</code> is
   * returned.
   *
   * <p>
   ...
   * effect as if it were equal to the length of this string: <code>-1</code> is
   * returned.
   *
   * <p>
   ...
   *         <code>fromIndex</code>, or <code>-1</code> if the character does not
   *         occur.
   */
   ...
   * character. For values of <code>ch</code> in the range from 0 to 0xFFFF
   ...
   * </pre>
   * 
   * </blockquote> is true. For other values of <code>ch</code>, it is the largest
   ...
   * 
   * </blockquote> is true. In either case, if no such character occurs in this
   * string, then <code>-1</code> is returned. The <code>String</code> is searched
   ...
   * <code>ch</code> in the range from 0 to 0xFFFF (inclusive), the index returned
   ...
   * 
   * </blockquote> is true. In either case, if no such character occurs in this
   * string at or before position <code>fromIndex</code>, then <code>-1</code> is
   * returned.
   *
   * <p>
   * All indices are specified in <code>char</code> values (Unicode code units).
   ...
   *          equal to one less than the length of this string: this entire string
   *          may be searched. If it is negative, it has the same effect as if it
   ...
   * smallest value <tt>k</tt> for which: <blockquote>
   * 
   * <pre>
   ...
   * the index value <code>this.length()</code>. The returned index is the largest
   * value <i>k</i> such that <blockquote>
   * 
   * <pre>
   ...
   * @param fromIndex
   *          the index to start the search from.
   * @return the index within this string of the last occurrence of the specified
   *         substring.
   */
   ...
   * @exception IndexOutOfBoundsException
   *              if <code>beginIndex</code> is negative or larger than the length
   ...
   *              if the <code>beginIndex</code> is negative, or
   *              <code>endIndex</code> is larger than the length of this
   *              <code>String</code> object, or <code>beginIndex</code> is larger
   ...
   * </blockquote>
   *
   * This method is defined so that the <tt>String</tt> class can implement the
   ...
   * <code>String</code> object is returned. Otherwise, a new <code>String</code>
   ...
   * sequence represented by this <code>String</code> object, then a reference to
   * this <code>String</code> object is returned. Otherwise, a new
   * <code>String</code> object is created that represents a character sequence
   * identical to the character sequence represented by this <code>String</code>
   * object, except that every occurrence of <code>oldChar</code> is replaced by
   * an occurrence of <code>newChar</code>.
   * <p>
   * Examples: <blockquote>
   * 
   * <pre>
   ...
   * <p>
   * An invocation of this method of the form
   * <i>str</i><tt>.matches(</tt><i>regex</i><tt>)</tt> yields exactly the same
   ...
   *
   * @return <tt>true</tt> if, and only if, this string matches the given regular
   *         expression
   *
   ...
   *
   * <p>
   * The string <tt>"boo:and:foo"</tt>, for example, yields the following results
   ...
   * <blockquote>
   * {@link java.util.regex.Pattern}.{@link java.util.regex.Pattern#compile
   * compile}<tt>(</tt><i>regex</i><tt>)</tt>.{@link java.util.regex.Pattern#split(java.lang.CharSequence,int)
   ...
   * using the rules of the given <code>Locale</code>. Case mapping is based on
   * the Unicode Standard version specified by the {@link java.lang.Character
   * Character} class. Since case mappings are not always 1:1 char mappings, the
   * resulting <code>String</code> may be a different length than the original
   * <code>String</code>.
   * <p>
   ...
   * and HTML tags. For instance, <code>"TITLE".toLowerCase()</code> in a Turkish
   * locale returns <code>"t\u0131tle"</code>, where '\u0131' is the LATIN SMALL
   * LETTER DOTLESS I character. To obtain correct results for locale insensitive
   * strings, use <code>toLowerCase(Locale.ENGLISH)</code>.
   * <p>
   * 
   * @return the <code>String</code>, converted to lowercase.
   ...
   * results if used for strings that are intended to be interpreted locale
   * independently. Examples are programming language identifiers, protocol keys,
   * and HTML tags. For instance, <code>"title".toUpperCase()</code> in a Turkish
   * locale returns <code>"T\u0130TLE"</code>, where '\u0130' is the LATIN CAPITAL
   * LETTER I WITH DOT ABOVE character. To obtain correct results for locale
   * insensitive strings, use <code>toUpperCase(Locale.ENGLISH)</code>.
   * <p>
   * 
   * @return the <code>String</code>, converted to uppercase.
   * @see java.lang.String#toUpperCase(Locale)
   ...
   * <p>
   * If this <code>String</code> object represents an empty character sequence, or
   ...
   * whose code is greater than <code>'&#92;u0020'</code>, and let <i>m</i> be the
   ...
   *
   * @return A copy of this string with leading and trailing white space removed,
   ...
   *          arguments are ignored. The number of arguments is variable and may
   *          be zero. The maximum number of arguments is limited by the maximum
   *          dimension of a Java array as defined by the
   *          <a href="http://java.sun.com/docs/books/vmspec/">Java Virtual
   *          Machine Specification</a>. The behaviour on a <tt>null</tt> argument
   *          depends on the
   ...
   *           arguments given the format string, or other illegal conditions. For
   *           specification of all possible formatting errors, see the
   *           <a href="../util/Formatter.html#detail">Details</a> section of the
   ...
   *
   * @param l
   *          The {@linkplain java.util.Locale locale} to apply during formatting.
   *          If <tt>l</tt> is <tt>null</tt> then no localization is applied.
   *
   * @param format
   *          A <a href="../util/Formatter.html#syntax">format string</a>
   *
   ...
   * @return a newly allocated string representing the same sequence of characters
   ...
   * <p>
   * The <code>offset</code> argument is the index of the first character of the
   * subarray. The <code>count</code> argument specifies the length of the
   ...
   * @exception IndexOutOfBoundsException
   *              if <code>offset</code> is negative, or <code>count</code> is
   *              negative, or <code>offset+count</code> is larger than
   ...
   * @return a <code>String</code> that contains the characters of the specified
   ...
   * @param data
   *          the character array.
   * @return a <code>String</code> that contains the characters of the character
   *         array.
   */
   ...
   * @param c
   *          a <code>char</code>.
   * @return a string of length <code>1</code> containing as its single character
   *         the argument <code>c</code>.
   */
   ...
   * Otherwise, this <code>String</code> object is added to the pool and a
   * reference to this <code>String</code> object is returned.
   * <p>
   * It follows that for any two strings <code>s</code> and <code>t</code>,
   * <code>s.intern()&nbsp;==&nbsp;t.intern()</code> is <code>true</code> if and
   * only if <code>s.equals(t)</code> is <code>true</code>.
   * <p>
   * All literal strings and string-valued constant expressions are interned.
   * String literals are defined in &sect;3.10.5 of the
  ...
  {
    return JavaLangSupport.intern(this);
  }
