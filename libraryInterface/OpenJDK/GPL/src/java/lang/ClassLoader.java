...
public abstract class ClassLoader {
    ...
    */
      ...
      throws ClassFormatError
    {
        ...
        //
//        ClassFileTransformer[] transformers = null; // ClassFileTransformer.getTransformers();
//        Class c = null;
//
...
//            throw cfe;
    ...
    {
        if (org.jikesrvm.VM.VerifyAssertions) org.jikesrvm.VM._assert(c != null, "Argument class was null");
        // According to the JavaDoc, this merely does the linking. This means that
    ...
    public final ClassLoader getParent() {
        ...
        if (sm != null) {
            checkClassLoaderPermission(parent, Reflection.getCallerClass(0));
        }
        return parent;
    }
    ...
    public static ClassLoader getSystemClassLoader() {
        ...
        SecurityManager sm = System.getSecurityManager();
        if (sm != null) {
            checkClassLoaderPermission(scl, Reflection.getCallerClass(0));
        }
        return scl;
    }
