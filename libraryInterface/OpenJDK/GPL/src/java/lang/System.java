...
public final class System
{
   ...
   * @throws SecurityException
   *           if a security manager exists and its <code>checkPermission</code>
   *           method doesn't allow reassigning of the standard error output
   *           stream.
   *
   * @see SecurityManager#checkPermission
   * @see java.lang.RuntimePermission
   ...
   *
   * @throws SecurityException
   *           If a security manager is present and it does not permit access to
   *           the channel.
   *
   * @since 1.5
   */
   ...
   * approximately 292 years (2<sup>63</sup> nanoseconds) will not accurately
   ...
   *              if an element in the <code>src</code> array could not be stored
  ...
  private static Properties initProperties(Properties props)
  {
    ...
    // sun.boot.library.path is mapped to sys_paths in java.lang.ClassLoader on
    // OpenJDK 6
    String sunBootLibraryPath = "/sun/boot"; // CommandLineArgs.getEnvironmentArg("sun.boot.library.path");
   ...
   *              specified property.
   * @exception NullPointerException
   *              if <code>key</code> or <code>value</code> is <code>null</code>.
   * @exception IllegalArgumentException
   *              if <code>key</code> is empty.
   * @see #getProperty
   ...
   *           doesn't allow access to the environment variable <code>name</code>
   * @see #getenv()
   ...
   *          exit status.
   * @throws SecurityException
   *           if a security manager exists and its <code>checkExit</code> method
  ...
  /**
   * Loads the system library specified by the <code>libname</code> argument. The
   * manner in which a library name is mapped to the actual system library is
   * system dependent.
   * <p>
  ...
  /**
   * The following two methods exist because in, out, and err must be initialized
   * to null. The compiler, however, cannot be permitted to inline access to them,
