...
// program generated file, do not edit
  ...
  private int word0;
     // stm; word:0 offset:0, bits:7, 92 rules);
     // r; word:0 offset:7, bits:7, 126 rules);
  ...
  public final int rule(int goalNT) {
    ...
    case r_NT:
      ...
      break;
    case czr_NT:
      stateNT = readPacked(0, 14, 0x3);
      break;
    case rs_NT:
      stateNT = readPacked(0, 16, 0x1F);
      break;
    case rz_NT:
      stateNT = readPacked(0, 21, 0x7);
      break;
    case rp_NT:
