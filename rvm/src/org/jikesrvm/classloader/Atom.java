...
public final class Atom {
  ...
  /**
   * The set of class prefixes that are not required to be loaded by bootstrap classloader,
   * although they're in the set of packages that would otherwise be loaded by the bootstrap
   * classloader.
   *
   * @see #isBootstrapClassDescriptor()
   */
  private static final byte[][] NON_BOOTSTRAP_CLASS_PREFIX_SET =
      {// tool classes
       ...
       // Classes generated by OpenJDK reflection implementations
       "Lsun/reflect/Generated".getBytes()};
