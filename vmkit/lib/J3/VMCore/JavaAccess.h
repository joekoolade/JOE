...
#define VM_CLASS      0x10000
#define VM_ARRAY      0x20000
#define VM_PRIMITIVE  0x40000
...
MK_VERIFIER(isClass,      VM_CLASS)
MK_VERIFIER(isPrimitive,  VM_PRIMITIVE)
MK_VERIFIER(isArray,      VM_ARRAY)
