...
public class CoreInputStream extends InputStream
{
  ...
  private int unsafeGetByte (long offset) {
    throw new RuntimeException("CoreInputStream.unsafeGetByte");   
  }
  private int copyIntoByteArray (byte[] dest, int offset, int numBytes) {
    throw new RuntimeException("CoreInputSTraem.copyIntoByteArray");    
  }
