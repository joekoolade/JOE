  ...
  implements Serializable
{
  ...
  private static final OID ID_DSA = null; //fixme: new OID("1.2.840.10040.4.1");
  private static final OID ID_DSA_WITH_SHA1 = null; //fixme: new OID("1.2.840.10040.4.3");
  private static final OID ID_RSA = null; //fixme: new OID("1.2.840.113549.1.1.1");
  private static final OID ID_RSA_WITH_MD2 = null; //fixme: new OID("1.2.840.113549.1.1.2");
  private static final OID ID_RSA_WITH_MD5 = null; //fixme: new OID("1.2.840.113549.1.1.4");
  private static final OID ID_RSA_WITH_SHA1 = null; //fixme: new OID("1.2.840.113549.1.1.5");

  private static final OID ID_EXTENSION = null; //fixme: new OID("2.5.29");
  private static final OID ID_KEY_USAGE = null; //fixme: ID_EXTENSION.getChild(15);
  private static final OID ID_BASIC_CONSTRAINTS = null; //fixme: ID_EXTENSION.getChild(19);
  private static final OID ID_EXT_KEY_USAGE = null; //fixme: ID_EXTENSION.getChild(37);
