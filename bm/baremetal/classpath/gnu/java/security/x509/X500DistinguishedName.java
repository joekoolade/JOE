...
public class X500DistinguishedName
{
  ...
  public static final OID CN         = null; //fixme: new OID("2.5.4.3");
  public static final OID C          = null; //fixme: new OID("2.5.4.6");
  public static final OID L          = null; //fixme: new OID("2.5.4.7");
  public static final OID ST         = null; //fixme: new OID("2.5.4.8");
  public static final OID STREET     = null; //fixme: new OID("2.5.4.9");
  public static final OID O          = null; //fixme: new OID("2.5.4.10");
  public static final OID OU         = null; //fixme: new OID("2.5.4.11");
  public static final OID T          = null; //fixme: new OID("2.5.4.12");
  public static final OID DNQ        = null; //fixme: new OID("2.5.4.46");
  public static final OID NAME       = null; //fixme: new OID("2.5.4.41");
  public static final OID GIVENNAME  = null; //fixme: new OID("2.5.4.42");
  public static final OID INITIALS   = null; //fixme: new OID("2.5.4.43");
  public static final OID GENERATION = null; //fixme: new OID("2.5.4.44");
  public static final OID EMAIL      = null; //fixme: new OID("1.2.840.113549.1.9.1");
  public static final OID DC         = null; //fixme: new OID("0.9.2342.19200300.100.1.25");
  public static final OID UID        = null; //fixme: new OID("0.9.2342.19200300.100.1.1");
