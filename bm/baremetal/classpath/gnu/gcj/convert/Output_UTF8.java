 ...
 * 
 * @author Per Bothner <bothner@cygnus.com>@date Match 1999.
 */
...
public class Output_UTF8 extends UnicodeToBytes
{
   ...
   * Otherwise, a surrogate pair is treated as two separate characters. Also,
   * '\0' is emitted as {0} if true, and as {0xC0,0x80} if false.
   */
