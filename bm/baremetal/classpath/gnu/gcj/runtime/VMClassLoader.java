...
public final class VMClassLoader extends java.net.URLClassLoader {
  ...
  /**
   * This is overridden to search the internal hash table, which will only
   * search existing linked-in classes. This will make the default
   * implementation of loadClass (in ClassLoader) work right. The implementation
   * of this method is in java/lang/natClassLoader.cc.
   */
  ...
  static VMClassLoader instance=null; //fixme: new VMClassLoader();
