...
public class Runtime
{
   ...
   *       ClassLoader first
   */
  static Properties defaultProperties = null; //new Properties();
/*  static
  {
...
*/
   ...
   */
  private static final Runtime current = null; // new Runtime();
  ...
  public int availableProcessors() {
    return baremetal.vm.Runtime.availableProcessors();
	}
  ...
  public long freeMemory() {
    return baremetal.vm.Runtime.freeMemory();
	}
  ...
  public long totalMemory() {
    return baremetal.vm.Runtime.totalMemory();
	}
  ...
  public long maxMemory() {
    return baremetal.vm.Runtime.maxMemory();
	}
   ...
   */
  Process execInternal(String[] cmd, String[] env, File dir) {
    return baremetal.vm.Runtime.exec(cmd, env, dir);
	}
  ...
  static void insertSystemProperties(Properties p) {
    baremetal.vm.Runtime.systemProperties(p);
	}
} // class Runtime
