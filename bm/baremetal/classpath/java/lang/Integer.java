...
public final class Integer extends Number implements Comparable {
  ...
  /**
   * The minimum value an <code>int</code> can represent is -2147483648 (or -2
   * <sup>31 </sup>).
   */
  public static final int MIN_VALUE=0x80000000;

  /**
   * The maximum value an <code>int</code> can represent is 2147483647 (or 2
   * <sup>31 </sup>- 1).
   */
   ...
   * decodable. The <code>decode()</code> method will be used to interpret the
  ...
  /**
   * Get the specified system property as an <code>Integer</code>, or use a
   * default <code>Integer</code> value if the property is not found or is not
   * decodable. The <code>decode()</code> method will be used to interpret the
   * value of the property.
   * 
   * @param nm
  ...
  /**
   * Behaves like <code>compareTo(Integer)</code> unless the Object is not an
   * <code>Integer</code>.
   * 
   * @param o
   *          the object to compare
   ...
   *           if the argument is not an <code>Integer</code>
