...
public final class Double extends Number implements Comparable
{
  ...
  public static double parseDouble(String s) {
      //fixme
    throw new RuntimeException("Double.parseDouble");    
  }
  ...
  public static long doubleToLongBits(double value) {
      // fixme
    throw new RuntimeException("Double.doubleToLongBits");    
  }
  // END GCJ LOCAL
  ...
  public static long doubleToRawLongBits(double value) {
      // fixme
    throw new RuntimeException("Double.doubleToRawLongBits");    
  }
  // END GCJ LOCAL
  ...
  public static double longBitsToDouble(long bits) {
      // fixme
    throw new RuntimeException("Double.lnngBitsToDouble");    
  }
  // END GCJ LOCAL
  ...
  static String toString(double d, boolean isFloat) {
      // fixme
    throw new RuntimeException("Double.toString");    
  }
}
