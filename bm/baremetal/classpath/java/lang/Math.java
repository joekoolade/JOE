...
public final class Math {
     ...
     * <code>3.141592653589793</code>. This is the ratio of a circle's
    ...
    /**
     * The trigonometric function <em>sin</em>. The sine of NaN or infinity
     * is NaN, and the sine of 0 retains its sign. This is accurate within 1
    ...
    /**
     * The trigonometric function <em>cos</em>. The cosine of NaN or infinity
     * is NaN. This is accurate within 1 ulp, and is semi-monotonic.
     * 
     * @param a
     *            the angle (in radians)
     * @return cos(a)
    ...
    /**
     * The trigonometric function <em>tan</em>. The tangent of NaN or
     * infinity is NaN, and the tangent of 0 retains its sign. This is accurate
    ...
    /**
     * The trigonometric function <em>arcsin</em>. The range of angles
     * returned is -pi/2 to pi/2 radians (-90 to 90 degrees). If the argument is
     * NaN or its absolute value is beyond 1, the result is NaN; and the arcsine
     * of 0 retains its sign. This is accurate within 1 ulp, and is
     * semi-monotonic.
     * 
     * @param a
    ...
    /**
     * The trigonometric function <em>arccos</em>. The range of angles
     * returned is 0 to pi radians (0 to 180 degrees). If the argument is NaN or
     ...
     * The trigonometric function <em>arcsin</em>. The range of angles
     * returned is -pi/2 to pi/2 radians (-90 to 90 degrees). If the argument is
     * NaN, the result is NaN; and the arctangent of 0 retains its sign. This is
     * accurate within 1 ulp, and is semi-monotonic.
     * 
     * @param a
     ...
     * infinity, the result is positive infinity; and if the argument is
     * negative infinity, the result is positive zero. This is accurate within 1
     * ulp, and is semi-monotonic.
     * 
     * @param a
    ...
    /**
     * Take ln(a) (the natural log). The opposite of <code>exp()</code>. If
     * the argument is NaN or negative, the result is NaN; if the argument is
     ...
     * {@link #floor(double)}. A value is a fixed point of a one-argument
     * method if and only if the result of applying the method to the value is
     * equal to the value.) This is accurate within 1 ulp, and is
     * semi-monotonic.
     * 
     * @param a
     *            the number to raise
     ...
     * value of <code>x - y * <em>n</em></code>, where <em>n</em> is the
     * closest double to <code>x / y</code> (ties go to the even n); for a
     * zero remainder, the sign is that of <code>x</code>. If either argument
     * is NaN, the first argument is infinite, or the second argument is zero,
     * the result is NaN; if x is finite but y is infinite, the result is x.
