...
public class Deflater
{
  ...
  private void init(int level, boolean noHeader) {
    throw new RuntimeException("Deflater.init");    
  }
  
  private void update() {
    throw new RuntimeException("Deflater.update");    
  }
   ...
   */
  public void reset() {
    throw new RuntimeException("Deflater.reset");    
  }
   ...
   */
  public void end() {
    throw new RuntimeException("Deflater.end");    
  }
   ...
   */
  public int getAdler() {
    throw new RuntimeException("Deflater.getAdler");    
  }
  ...
  public int getTotalIn() {
    throw new RuntimeException("Deflater.getTotalIn");    
  }
  ...
  public int getTotalOut() {
    throw new RuntimeException("Deflater.getTotalOut");    
  }
   ...
   */
  public void finish() {
    throw new RuntimeException("Deflater.finish");    
  }
  ...
  public boolean needsInput() {
    throw new RuntimeException("Deflater.needsInput");    
  }
  ...
  public void setInput(byte[] input, int off, int len) {
    throw new RuntimeException("Deflater.setInput");    
  }
  ...
  public int deflate(byte[] output, int off, int len) {
    throw new RuntimeException("Deflater.deflate");    
  }
  ...
  public void setDictionary(byte[] buf, int off, int len) {
    throw new RuntimeException("Deflator.setDictionary");    
  }
}
