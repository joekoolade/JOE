 ...
 * Java Language Specification", ISBN 0-201-63451-1 Status: Believed complete
 * and correct to 1.3
 */
 ...
 * detected by calling the <code>checkError()</code> method. Additionally,
 * this stream can be designated as "autoflush" when created so that any writes
 * are automatically flushed to the underlying output sink when the current
 * line is terminated.
 * <p>
...
public class PrintStream extends FilterOutputStream {
  ...
  /**
   * This method intializes a new <code>PrintStream</code> object to write to
   * the specified output sink.
   * 
   * @param out
   ...
   * <code>print</code> or <code>println</code> call, when the <code>write</code>
   * methods with array arguments are called, or when a single new-line
   ...
   *          The <code>OutputStream</code> to write to.
   * @param auto_flush
   *          <code>true</code> to flush the stream after every line, <code>false</code>
   *          otherwise
   */
