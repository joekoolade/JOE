...
*/
   ...
   */
  int open(String path, int mode) throws FileNotFoundException {
    throw new RuntimeException("not implemented");
	}
  ...
  // will grow).
  int seek(long pos, int whence, boolean eof_trunc) throws IOException {
    throw new RuntimeException("not implemented");
	}
  ...
  void setLength(long pos) throws IOException {
    throw new RuntimeException("not implemented");
	}

  void lock(long pos, int len, boolean shared) throws IOException {
    throw new RuntimeException("not implemented");
	}
  boolean tryLock(long pos, int lent, boolean shared) throws IOException {
    throw new RuntimeException("not implemented");
	}
  void unlock(long pos, int len) throws IOException {
    throw new RuntimeException("not implemented");
	}
