...
public class File implements Serializable, Comparable
{
   ...
   * 
   * fixme: really need to setup the system properties!
   */
  ...
  static String dupSeparator = ""; // fixme: separator + separator;

  // fixme: this is going to need a lot of work!
//  static
//  {
...
//  }
  ...
  private static void init_native() {
    throw new RuntimeException("not implemented");
	}
  ...
  private static long counter = 0; // fixme: Double.doubleToLongBits (Math.random());
  ...
  private boolean performCreate() throws IOException {
    throw new RuntimeException("not implemented");
	}
   ...
   * directory
   */
  private final Object[] performList (FilenameFilter filter,
   ...
   */
  private final boolean performMkdir() {
    throw new RuntimeException("not implemented");
	}
   ...
   */
  private boolean performSetReadOnly() {
    throw new RuntimeException("not implemented");
	}
  ...
  private static File[] performListRoots() {
    throw new RuntimeException("not implemented");
	}
   ...
   */
  private boolean performRenameTo (File dest) {
    throw new RuntimeException("not implemented");
	}
   ...
   */
  private boolean performSetLastModified(long time) {
    throw new RuntimeException("not implemented");
	}
